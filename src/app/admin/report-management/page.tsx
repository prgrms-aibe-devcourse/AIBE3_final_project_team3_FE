      ...
      <main className="max-w-6xl mx-auto p-8">
        ...
        <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
          ...
          {!isLoading && list.length === 0 && (
            <div className="p-10 text-center text-gray-500">신고 내역이 없습니다.</div>
          )}
              ...
              <table className="w-full">
                <thead className="bg-gray-50 border-b">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left text-sm font-semibold">신고 메세지</th>
                    <th className="px-4 py-3 text-left text-sm font-semibold">신고 사유</th> {/* ⭐ 추가 */}
        ...
        {selected && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-end z-50">
            <div className="w-[420px] h-full bg-white shadow-xl p-6 overflow-y-auto">
              ...
              {/* 신고 메세지 */}
              <div className="mb-4">
                <label className="text-sm font-semibold block mb-2">신고 메세지</label>
                <textarea
                  readOnly
              ...
              {/* ⭐ 신고 사유 */}
              <div className="mb-4">
                <label className="text-sm font-semibold block mb-2">신고 사유</label>
                <textarea
                  readOnly
