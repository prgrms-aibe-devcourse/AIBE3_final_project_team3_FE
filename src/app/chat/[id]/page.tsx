...
import { MessageResp } from "@/global/types/auth.types"; // MessageResp 임포트
...
export default function ChatRoomPage() {
  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    if (client.connected) { // Changed from client.active to client.connected
        ...
        {messages.map((msg) => (
          <div
            ...
            className={`flex items-end gap-2 ${
              msg.senderId === member?.id ? "justify-end" : "justify-start"
            }`}
          >
